...
extension KSOptions {
    static var assStyle: String {
        if #available(iOS 14, macOS 11.0, tvOS 14, *) {
            "Style: Default,\(textFontName),\(Int(subtitleFontSize)),\(textColor.assColor),\(textColor.assColor),\(textBackgroundColor.assColor),\(textBackgroundColor.assColor),\(textBold ? "1" : "0"),\(textItalic ? "1" : "0"),0,0,100,100,0,0,1,1,0,\(textPosition.alignment),\(KSOptions.textPosition.leftMargin),\(textPosition.rightMargin),\(KSOptions.textPosition.verticalMargin),1"
        } else {
            "Style: Default,\(textFontName),\(Int(subtitleFontSize)),&Hffffff,&Hffffff,&H0,&H0,\(textBold ? "1" : "0"),\(textItalic ? "1" : "0"),0,0,100,100,0,0,1,1,0,\(textPosition.alignment),\(KSOptions.textPosition.leftMargin),\(textPosition.rightMargin),\(KSOptions.textPosition.verticalMargin),1"
        }
    }
}
